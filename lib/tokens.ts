...
export const EVM_TOKENS: Record<string, TokenInfo[]> = {
  zetachain: [
    ...
    { symbol: 'USDC.SOL', name: 'USDC on Solana', logo: 'USDC', addressByNetwork: { mainnet: '0x8344d6f84d26f998fa070BbEA6D2E15E359e2641' } },
    ...
    { symbol: 'POL.POL', name: 'POL on Polygon', logo: 'MATIC', addressByNetwork: { mainnet: '0xADF73ebA3Ebaa7254E859549A44c74eF7cff7501', testnet: '0x777915D031d1e8144c90D025C594b3b8Bf07a08d' } },
    ...
    { symbol: 'AVAX.AVAX', name: 'AVAX on Avalanche', logo: 'AVAX', addressByNetwork: { mainnet: '0xE8d7796535F1cd63F0fe8D631E68eACe6839869B', testnet: '0xEe9CC614D03e7Dbe994b514079f4914a605B4719' } },
    ...
    { symbol: 'USDC.AVAX', name: 'USDC on Avalanche', logo: 'USDC', addressByNetwork: { mainnet: '0xa52Ad01A1d62b408fFe06C2467439251da61E4a9', testnet: '0x8344d6f84d26f998fa070BbEA6D2E15E359e2641' } },
    ...
    { symbol: 'USDC.POL', name: 'USDC on Polygon', logo: 'USDC', addressByNetwork: { mainnet: '0xfC9201f4116aE6b054722E10b98D904829b469c3', testnet: '0xe573a6e11f8506620F123DBF930222163D46BCB6' } },
    ...
    { symbol: 'USDC.SOL', name: 'USDC on Solana Devnet', logo: 'USDC', addressByNetwork: { testnet: '0xD10932EB3616a937bd4a2652c87E9FeBbAce53e5' } },
    { symbol: 'USDC.SUI', name: 'USDC on Sui Testnet', logo: 'USDC', addressByNetwork: { testnet: '0xE80e3e8Ac1C19c744d4c2147172489BEAF23E3C5' } },
