...
export default function ReceiveFlow({ asset, onClose }: ReceiveFlowProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50 pb-24 sm:pb-4">
      <Card className="w-full max-w-md max-h-[calc(100vh-8rem)] sm:max-h-[calc(100vh-12rem)] overflow-y-auto">
